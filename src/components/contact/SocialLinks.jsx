...
const SocialLinks = () => {
  return (
    <div className="flex flex-wrap justify-center gap-4 mt-6 lg:justify-start">
      <Link
        to="https://www.facebook.com/SifatUllahShoyon"
        target="_blank"
      ...
      <Link
        to="https://www.instagram.com/sifatullahshoyon/"
        target="_blank"
        className="w-10 h-10 flex items-center justify-center rounded-lg bg-white text-[#0e051a] hover:scale-110 transition-transform"
      >
        <Instagram size={25} />
      ...
      <Link
        to="https://github.com/sifatullahshoyon"
        target="_blank"
        className="w-10 h-10 flex items-center justify-center rounded-lg bg-white text-[#0e051a] hover:scale-110 transition-transform"
      >
        <Github size={25} />
